...
ORCHESTRATION_SWITCHES: dict[str, dict[str, Any]] = {
    ...
    "show_brewtracker_runtime": {
        "name": "BrewAssistant Show BrewTracker Runtime",
        "object_id": "brewassistant_show_brewtracker_runtime",
        "icon": "mdi:timer-play-outline",
        "default": True,
        "kind": "dashboard_visibility",
        "module": "brewtracker_runtime",
        "card": "dashboard/cards/brewtracker_runtime.yaml",
    },
    "show_brewfather_recipe": {
        "name": "BrewAssistant Show Brewfather Recipe",
        "object_id": "brewassistant_show_brewfather_recipe",
        "icon": "mdi:file-document-outline",
        "default": True,
        "kind": "dashboard_visibility",
        "module": "brewfather_recipe",
        "card": "dashboard/cards/brewfather_recipe.yaml",
    },
    "show_brewzilla": {
    ...
    "show_brewzilla_local_control": {
        "name": "BrewAssistant Show BrewZilla Local Control",
        "object_id": "brewassistant_show_brewzilla_local_control",
        "icon": "mdi:kettle-steam-outline",
        "default": True,
        "kind": "dashboard_visibility",
        "module": "brewzilla_local_control",
        "card": "dashboard/cards/brewzilla_local_control.yaml",
    },
    "show_brewzilla_learning": {
        "name": "BrewAssistant Show Brewday Advice",
    ...
    "show_brewzilla_safety_rcl": {
        "name": "BrewAssistant Show Safety/RCL",
        "object_id": "brewassistant_show_brewzilla_safety_rcl",
        "icon": "mdi:shield-alert-outline",
        "default": False,
        "kind": "dashboard_visibility",
        "module": "brewzilla_safety_rcl",
        "card": "dashboard/cards/brewzilla_safety_rcl.yaml",
    },
    "show_event_log": {
