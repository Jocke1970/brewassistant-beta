...
class BrewAssistantCoordinator(DataUpdateCoordinator[BrewAssistantData]):
    ...
    def configured_entities(self) -> dict[str, Any]:
        return {
            ...
            CONF_GF30_COOLANT_TEMP_ENTITY: _entity_from_entry(
                self.config_entry,
                CONF_GF30_COOLANT_TEMP_ENTITY,
                DEFAULT_GF30_COOLANT_TEMP_ENTITY,
            ),
            CONF_GF30_FREEZER_AIR_TEMP_ENTITY: _entity_from_entry(
                self.config_entry,
                CONF_GF30_FREEZER_AIR_TEMP_ENTITY,
                DEFAULT_GF30_FREEZER_AIR_TEMP_ENTITY,
            ),
            CONF_GF30_COOLANT_THERMOSTAT_ENTITY: _entity_from_entry(
                self.config_entry,
                CONF_GF30_COOLANT_THERMOSTAT_ENTITY,
                DEFAULT_GF30_COOLANT_THERMOSTAT_ENTITY,
            ),
