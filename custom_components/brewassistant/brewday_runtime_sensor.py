...
) -> list["BrewAssistantBrewdayRuntimeSensor"]:
    """Create all Brewday Runtime sensor entities."""
    return [BrewAssistantBrewdayRuntimeSensor(coordinator, key) for key in BREWDAY_RUNTIME_SENSORS]
